...
setup(
    ...
    url="https://github.com/EfficientMoE/Pregated-MoE",
    project_urls={"Homepage": "https://github.com/EfficientMoE/Pregated-MoE"},
    classifiers=[
