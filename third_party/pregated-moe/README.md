...
Pregated-MoE is a cost-effective, fast, and easy-to-use library for Mixture-of-Experts (MoE) inference.

Pregated-MoE is cost-effective yet fast:
...
| :---: | :---: | :---: | :---: | :---: | :---: |
| <ins>Pregated-MoE</ins> | <ins>*0.130*</ins>	| <ins>*0.119*</ins> | <ins>*0.735*</ins> | <ins>*0.100*</ins> | <ins>*0.150*</ins> |
...
| :---: | :---: | :---: | :---: |
| <ins>Pregated-MoE</ins> | <ins>*69.105*</ins>	| <ins>*30.300*</ins> | <ins>*12.579*</ins> |
...
We recommend installing Pregated-MoE in a virtual environment. To install Pregated-MoE, you can either install it from PyPI or build it from source.

```bash
conda create -n pregated-moe python=3.9
conda activate pregated-moe
...
pip install pregated-moe

# install nightly release
pip install -i https://test.pypi.org/simple/ --extra-index-url https://pypi.org/simple/ pregated-moe
```

### Install from Source

```bash
git clone https://github.com/EfficientMoE/Pregated-MoE.git
cd Pregated-MoE
pip install -e .
...
```
Post-installation, Pregated-MoE will automatically integrate with FlashAttention to enhance performance.

## Usage and Examples

We provide a simple API for diverse setups, including single GPU, multiple GPUs, and multiple nodes. The following examples show how to use Pregated-MoE to run generation on a Huggingface LLM model.
...
config = {
    "offload_path": os.path.join(user_home, "pregated-moe"),
...
```bash
python -m pregated_moe.entrypoints.openai.api_server --model deepseek-ai/DeepSeek-V2-Lite-Chat --offload-dir ./offload_dir
```
