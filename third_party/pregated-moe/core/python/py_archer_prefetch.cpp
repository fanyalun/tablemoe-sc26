...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
  ...
  py::class_<ArcherPrefetchHandle>(m, "prefetch_handle")
      ...
      .def("begin_exact_request", &ArcherPrefetchHandle::BeginExactRequest)
      .def("submit_exact_layer", &ArcherPrefetchHandle::SubmitExactLayer)
      .def("wait_layer_ready", &ArcherPrefetchHandle::WaitLayerReady)
      .def("release_layer", &ArcherPrefetchHandle::ReleaseLayer)
      .def("end_exact_request", &ArcherPrefetchHandle::EndExactRequest)
      .def("get_exact_prepare_stats",
           &ArcherPrefetchHandle::GetExactPrepareStats)
