...
import moe_infinity
from moe_infinity.common import (
...
class OffloadEngine(object):
    ...
    def __enter__(self):
        ...
        if current_arch == "deepseek":
            ...
            moe_infinity.models.modeling_deepseek_v2.modeling_deepseek.DeepseekV2MoE = (
                DeepseekMoEBlock
            )
            ...
            moe_infinity.models.modeling_deepseek_v3.modeling_deepseek.DeepseekV3MoE = (
                DeepseekMoEBlock
            )
    ...
    def setup_archer_hooks(self, model):
        ...
        if enable_recursive_hooks:
            ...
            print(
                f"[MoE-Infinity] Skip recursive module hooks for architecture `{arch}`"
            )
